/*
 * Javascript EXIF Reader 0.1.4		(changed see line 521, hs)
...
EXIF.GPSTags = {
	...
	0x0002 : "GPSLatitude", // Î³¶È
	0x0003 : "GPSLongitudeRef",
	0x0004 : "GPSLongitude", // ¾­¶È
		...
		for (var strTag in oEXIFTags) {
			switch (strTag) {
				...
				case "ExposureTime":
					...
					break;
// Start "ExposureBias" digits making shorter, copied from above: case 'ExposureTime'
					case "ExposureBias":	// Trying to make ExposureBias number shorter,
											// some camera models give for example 0.3333333333 			
					if (oEXIFTags.ExposureBias < 4)		// Mostly this number is max. 3 or -3
					{
// to your choice		oEXIFTags.ExposureBias = + oEXIFTags.ExposureBias.toFixed(2);
						oEXIFTags.ExposureBias = + Math.round(oEXIFTags.ExposureBias * 100) / 100;
					}
					else
					{
		//				oEXIFTags.ExposureBias = oEXIFTags.ExposureBias + "";
						oEXIFTags.ExposureBias = oEXIFTags.ExposureBias + "\"";		// see above: .ExposureTime + "\""
					}
					break;
// Finish "ExposureBias" digits making shorter
			}
